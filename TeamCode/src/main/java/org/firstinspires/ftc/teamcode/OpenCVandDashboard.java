...
public class OpenCVandDashboard extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    int[] viewportContainerIds = OpenCvCameraFactory
      .getInstance()
    ...
    DistanceFromPaperTracker data = new DistanceFromPaperTracker(
      pctThreshold,
      thresholdThresh,
      thresholdMaxVal,
      cannyMinThreshold,
    ...
    openCvPassthrough.openCameraDeviceAsync(
      new OpenCvCamera.AsyncCameraOpenListener() {
        ...
        public void onOpened() {
          ...
          openCvPassthrough.setViewportRenderer(
            OpenCvCamera.ViewportRenderer.GPU_ACCELERATED
          );
          ...
          openCvPassthrough.startStreaming(
            0,
            0,
